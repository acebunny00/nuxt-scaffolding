	...
	<UAccordion :items="items">
		...
		<template #getting-started>
			<div class="text-gray-900 dark:text-white text-center">
				...
				<p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Fully styled and customizable components for Nuxt.</p>
			</div>
		</template>
		...
		<template #installation="{ description }">
			<div class="flex flex-col justify-center items-center gap-1 mb-4">
				...
				<p class="text-sm text-gray-500 dark:text-gray-400">Install <code>@nuxt/ui</code> dependency to your project:</p>
				<p>
					{{ description }}
				</p>
			</div>
